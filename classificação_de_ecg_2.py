...
Original file is located at
    https://colab.research.google.com/drive/19LsVnQ0sUUyMjtJhDGzL6gmk1ENusJYu
"""
...
X_train = pd.read_excel('/content/drive/MyDrive/UFPA/Mestrado/Disciplinas/Redes Neurais/Trabalho 4 - Artigo/Dados/Complexo QRS/DS1/DS1.xlsx')
X_test = pd.read_excel('/content/drive/MyDrive/UFPA/Mestrado/Disciplinas/Redes Neurais/Trabalho 4 - Artigo/Dados/Complexo QRS/DS2/DS2.xlsx')

Y_train = pd.read_csv('/content/drive/MyDrive/UFPA/Mestrado/Disciplinas/Redes Neurais/Trabalho 4 - Artigo/Dados/Complexo QRS/DS1/DS1_labels.csv', header=None)
Y_test = pd.read_csv('/content/drive/MyDrive/UFPA/Mestrado/Disciplinas/Redes Neurais/Trabalho 4 - Artigo/Dados/Complexo QRS/DS2/DS2_labels.csv',header=None)
...
X_train = pd.read_excel('/content/drive/MyDrive/UFPA/Mestrado/Disciplinas/Redes Neurais/Trabalho 4 - Artigo/Dados/Complexo QRS/DS1/DS1.xlsx')
Y_train = pd.read_csv('/content/drive/MyDrive/UFPA/Mestrado/Disciplinas/Redes Neurais/Trabalho 4 - Artigo/Dados/Complexo QRS/DS1/DS1_labels.csv', header=None, names=['classes'])

X_test = pd.read_excel('/content/drive/MyDrive/UFPA/Mestrado/Disciplinas/Redes Neurais/Trabalho 4 - Artigo/Dados/Complexo QRS/DS2/DS2.xlsx')
Y_test = pd.read_csv('/content/drive/MyDrive/UFPA/Mestrado/Disciplinas/Redes Neurais/Trabalho 4 - Artigo/Dados/Complexo QRS/DS2/DS2_labels.csv',header=None, names=['classes'])
